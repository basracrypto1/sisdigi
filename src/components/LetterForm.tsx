...
export const LetterForm = forwardRef<LetterFormHandle, Props>(({ data, onChange, onRefreshNumber, onFinish }, ref) => {
  ...
  return (
    <div id="form-top" className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-shrink-0 mb-4 sm:mb-8 mt-1 sm:mt-2 overflow-x-auto pb-2 px-4 sm:px-6 md:px-8 lg:px-10">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="p-2.5 bg-paper border border-line rounded-lg text-accent hover:bg-accent hover:text-white transition-all shadow-sm"
                      >
                    ...
                    <div className="p-5 bg-paper border border-line rounded-2xl space-y-4">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          <label className="flex flex-col items-center justify-center w-full py-4 bg-paper border border-dashed border-line rounded-xl cursor-pointer hover:border-accent hover:bg-accent/5 transition-all">
                      ...
                      <div className="relative">
                        ...
                        <button 
                          className={`text-[9px] font-black uppercase tracking-[2px] px-4 py-2 rounded-xl transition-all flex items-center gap-2 shadow-sm border ${
                            isScanning ? 'bg-bg text-ink/20 border-line' : 'bg-paper text-accent border-accent/20 hover:bg-accent/5'
                          }`}
                        >
